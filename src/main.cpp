...
Q_DECL_EXPORT int main(int argc, char *argv[])
{
    ...
    KAboutData aboutData(QStringLiteral("calindori"), i18n("Calindori"), QStringLiteral("1.3.0"), i18nc("@title", "Calendar application"), KAboutLicense::GPL_V3, i18nc("@info:credit", "(c) 2018-2020 The Calindori Team"));
